...
use App\Http\Controllers\testBlockChainController;
...
use App\Http\Controllers\Admin\SeedsandSeedlingsController;
...
use App\Http\Controllers\testQRController;
use App\Http\Controllers\Admin\AccuracyController;
...
Route::get('/checkBlock/{number}/{blockchaindb}', [TrangChuController::class,'checkBlock']);
Route::get('check-Block-Content/{id}-{slug}.html',[TrangChuController::class, 'checkBlock_ProductContent']);
...
Route::get('/testQRcode', [testQRController::class, 'index']);
...
Route::post('/services/load-products', [TrangChuController::class, 'loadProduct']);
Route::get('/about.html', [TrangChuController::class, 'about']);
Route::get('/contact.html', [TrangChuController::class, 'contact']);
Route::post('/contact.html', [TrangChuController::class, 'sendMess']);
Route::get('san-pham/{id}-{slug}.html',[TrangChuController::class, 'productContent']);
