...
use App\Http\BlockChain\BlockChainSaleroom;
...
//                                dd($saleroomsLast);
                                $saleroomsChain = new BlockChainSaleroom(2);
...
//                                dd($saleroomsChain->getLastBlock());
//                                dd($saleroomsChain->difficulty);
...
//                                        dd("giống");
                                ...
                                $saleroomChain = new BlockChainSaleroom(2);
