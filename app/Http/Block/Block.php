...
//        dd($this->prevHash.$dataString.$this->mineVar.$this->timeStamp);
        $blockString = $this->prevHash.$dataString.$this->mineVar.$this->timeStamp;
        $hash = hash('sha256',$blockString);
