                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-caption relative">
                                            <div class="row d_flex">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="banner_img">
                                                        <figure><img class="img_responsive" src="{{ $images[0]->thumb1 }}"></figure>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-caption relative">
                                            <div class="row d_flex">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="banner_img">
                                                        <figure><img class="img_responsive" src="{{ $images[1]->thumb1 }}"></figure>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @if($saleroom->id == (int)$arrs[$i])
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 text_align_center">
                            ...
                            <div class="quality-box ">
                                <figure><img width="200px" src="{{ $saleroom->thumb_saleroom }}" alt="#"/></figure>
                            </div>
                            <br>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h2 style="color: #f87c7c">{{ $blockUser->ten_cg }}</h2>
            ...
            <div class="modal-body">
                <div class="col-12">
                    <table class="table table-image">
                        ...
                        <tr>
                            <th colspan="3" scope="col">Chi Tiết Cây Giống
                        </tr>
                        <tr>
                            <th colspan="3" scope="col"><img src="{{ $blockUser->thumb_cg }}" class="img-fluid img-thumbnail" alt="Sheep"></th>
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Thông tin</th>
                        </tr>
                        <tr>
                            <th scope="col">{{ $blockUser->ten_cg }}</th>
                            <td colspan="2">{{ $blockUser->mota_cg }}</td>
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Chi Tiết</th>
                        </tr>
                        <tr>
                            <td colspan="3" >{{ $blockUser->chitiet_cg }}</td>
                        </tr>
{{--                        <tr>--}}
{{--                            <th scope="row">2</th>--}}
{{--                            <td class="w-25">--}}
    ...
    <div class="about">
        <div class="container">
            <div class="row d_flex">
                <div class="col-md-6">
                    <div class="titlepage text_align_left ">
                        <h2>{{ $blockUser->tennv }}</h2>
                        <p style="height:500px; overflow:hidden">{{ $blockUser->mota_nv }}
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="about_img text_align_left">
                        <figure><img class="img_responsive" src="{{ $blockUser->thumb_nv }}" alt="#"/></figure>
                    </div>
                </div>
                <a type="button" class="read_more" data-toggle="modal" data-target=".bd-example-modal-lg1" href="about.html">Read More</a>
            </div>
        </div>
    </div>
</div>
<div style="color: black" class="modal fade bd-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h2 style="color: #f87c7c">           {{ $blockUser->tennv }}</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="col-12">
                    <table class="table table-image">
                        <thead>
                        <tr>
                            <th colspan="3" scope="col">Thông tin</th><img src="{{ $blockUser->thumb_nv }}" class="img-fluid img-thumbnail" alt="Sheep">
                        </tr>
                        <tr>
                            <th width="30%" scope="col">Mã Vùng Trồng</th>
                            <th width="40%"scope="col">Tên Nhà Vườn</th>
                            <th width="30%"scope="col">Số Điện Thoại</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td >{{ $blockUser->mavungtrong }}</td>
                            <td >{{ $blockUser->tennv }}</td>
                            <td >{{ $blockUser->sodienthoai_nv }}</td>
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Địa chỉ</th>
                        </tr>
                        <tr>
                            <td colspan="3">{{ $blockUser->diachi_nv }}</td>
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Mô Tả</th>
                        </tr>
                        <tr>
                            <td colspan="3" >{{ $blockUser->mota_nv }}</td>
                        </tr>
                        {{--                        <tr>--}}
                        {{--                            <th scope="row">2</th>--}}
                        {{--                            <td class="w-25">--}}
    ...
    <div class="about">
        <div class="container">
            <div class="row d_flex">
                <div class="col-md-6">
                    <div class="titlepage text_align_left ">
                        <h2>Kĩ Thuật Trồng</h2>
                        <p id="p_cropdetail" style="height:500px; overflow:hidden">{{ $blockUser->chitiet_ct }}
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="about_img text_align_left">
                        <figure><img class="img_responsive" src="{{ $blockUser->thumb_ct }}" alt="#"/></figure>
                    </div>
                </div>
                <a type="button" class="read_more" data-toggle="modal" data-target=".bd-example-modal-lg2" href="about.html">Read More</a>
            </div>
        </div>
    </div>
</div>
<div style="color: black" class="modal fade bd-example-modal-lg2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h2 style="color: #f87c7c">Tên Cây Trồng</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="col-12">
                    <table class="table table-image">
                        <thead>
                        <tr>
                            <th colspan="3" scope="col">Thông Tin</th><img src="{{ $blockUser->thumb_ct }}" class="img-fluid img-thumbnail" alt="Sheep">
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Mô Tả</th>
                        </tr>
                        ...
                        <tbody>
                        <tr>
                            <td >{{ $blockUser->mota_ct }}</td>
                        </tr>
                        <tr>
                            <th colspan="3" scope="col">Chi Tiết</th>
                        </tr>
                        <tr>
                            <td colspan="3">{{ $blockUser->chitiet_ct }}</td>
                        </tr>
                        {{--                        <tr>--}}
                        {{--                            <th scope="row">2</th>--}}
                        {{--                            <td class="w-25">--}}
...
{{--                <form id="request" action="http://127.0.0.1:8000/contact.html" method="post" class="main_form">--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-md-6">--}}
{{--                            <input class="contactus" placeholder="Email" type="type" name="email" required>--}}
{{--                        </div>--}}
{{--                        <div class="col-md-6">--}}
{{--                            <textarea class="textarea" placeholder="Message" type="type" name="msg" required Message="Name"></textarea>--}}
{{--                        </div>--}}
{{--                        <div class="col-md-12">--}}
